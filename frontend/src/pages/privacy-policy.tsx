    ...
    <div className='flex flex-col min-h-screen'>
      ...
      <main className='bg-beige flex flex-grow justify-center'>
        <article className='lg:max-w-screen-sm max-w-552 font-kinuta text-gray-500 m-4'>
          <h1 className='text-lg md:text-2xl m-4 md:m-8 text-mainBlack text-center'>
            プライバシーポリシー
          </h1>
          <p className='text-xs md:text-base mb-4 md:mb-8 leading-6 md:leading-8'>
            「アウトドア般若心経」（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
          </p>
          <h2 className='text-base md:text-xl mb-4 text-mainBlack'>第1条（個人情報）</h2>
          <p className='text-xs md:text-base mb-8 leading-6 md:leading-8'>
            「個人情報」とは、個人情報保護法にいう「個人情報」を指すものとし、生存する個人に関する情報であって、当該情報に含まれる氏名、生年月日、住所、電話番号、連絡先その他の記述等により特定の個人を識別できる情報及び容貌、指紋、声紋にかかるデータ、及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。
          </p>
          <h2 className='text-base md:text-xl mb-4 text-mainBlack'>第2条（個人情報の収集方法）</h2>
          <p className='text-xs md:text-base mb-8 leading-6 md:leading-8'>
          ...
          <p className='text-xs md:text-base mb-4 leading-6 md:leading-8'>
            本サービスが個人情報を収集・利用する目的は、以下のとおりです。
          </p>
          <ol className='text-xs md:text-base list-decimal mb-8 px-6 leading-6 md:leading-8'>
          ...
          <h2 className='text-base md:text-xl mb-4 text-mainBlack'>第4条（利用目的の変更）</h2>
          <ol className='text-xs md:text-base list-decimal mb-8 px-6 leading-6 md:leading-8'>
            <li>
          ...
          <ol className='text-xs md:text-base list-decimal mb-8 px-6 leading-6 md:leading-8'>
            <li>
              ...
              <ol className='text-xs md:text-base list-decimal px-6 py-4 leading-6 md:leading-8'>
                <li>
                ...
                <li>
                  ...
                  <ol className='text-xs md:text-base list-decimal px-6 pt-4 leading-6 md:leading-8'>
          ...
          <h2 className='text-base md:text-xl mb-4 text-mainBlack'>第6条（退会時）</h2>
          <p className='text-xs md:text-base mb-8 leading-6 md:leading-8'>
          ...
          <p className='text-xs md:text-base mb-1 leading-6 md:leading-8'>
