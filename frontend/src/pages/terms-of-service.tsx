    ...
    <div className='flex flex-col min-h-screen'>
      ...
      <main className='bg-beige flex flex-grow justify-center'>
        <article className='max-w-screen-sm  font-kinuta text-black/50 p-8'>
          <h1 className='text-2xl mb-4 text-black/50 text-center'>利用規約</h1>
          <p className='mb-8'>
          ...
          <h2 className='text-xl mb-4 text-black/70'>第1条（適用）</h2>
          <ol className='list-decimal mb-6 mx-6'>
            <li>
          ...
          <h2 className='text-xl mb-4 text-black/70'>第2条（利用登録）</h2>
          <ol className='list-decimal mb-8 px-6'>
            ...
            <li>
              ...
              <ol className='list-decimal my-4 px-6'>
          ...
          <h2 className='text-xl mb-4 text-black/70'>第3条（ユーザー情報の管理）</h2>
          <ol className='list-decimal mb-8 mx-6'>
            <li>
          ...
          <h2 className='text-xl mb-4 text-black/70'>第4条（利用料金）</h2>
          <p className='mb-8'>
            ユーザーは、本サービスを無料で利用することができます。本サービス内で利用料金を請求することはありません。
          </p>

          <h2 className='text-xl mb-4 text-black/70'>第5条（禁止事項）</h2>
          <p className='mb-4'>
          ...
          <h2 className='text-xl mb-4 text-black/70'>第6条（本サービスの提供の停止等）</h2>
          <ol className='list-decimal mb-8 mx-6'>
            <li>
              本サービスは、以下のいずれかの事由があると判断した場合、ユーザーに事前に通知することなく本サービスの全部または一部の提供を停止または中断することができるものとします。
              <ol className='list-decimal my-4 mx-6'>
          ...
          <h2 className='text-xl mb-4 text-black/70'>第7条（利用制限および登録抹消）</h2>
          <ol className='list-decimal mb-8 mx-6'>
            <li>
          ...
          <h2 className='text-xl mb-4 text-black/70'>第8条（退会）</h2>
          <p className='mb-8'>
            ユーザーは、本サービスの定める退会手続により、本サービスから退会できるものとします。
          </p>

          <h2 className='text-xl mb-4 text-black/70'>第9条（保証の否認および免責事項）</h2>
          <ol className='list-decimal mb-8 mx-6'>
            <li>
          ...
          <h2 className='text-xl mb-4 text-black/70'>第14条（権利義務の譲渡の禁止）</h2>
          <p className='mb-8'>
            ユーザーは、本サービスの書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。
          </p>

          <h2 className='text-xl mb-4 text-black/70'>第15条（準拠法・裁判管轄）</h2>
          <ol className='list-decimal mb-8 mx-6'>
