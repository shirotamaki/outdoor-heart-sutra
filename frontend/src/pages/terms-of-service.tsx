    ...
    <div className='flex flex-col min-h-screen'>
      ...
      <main className='bg-beige flex flex-grow justify-center'>
        <article className='lg:max-w-screen-sm max-w-552 font-kinuta text-gray-500 m-4'>
          ...
          <ol className='text-xs md:text-base list-decimal mb-6 mx-6 leading-6 md:leading-8'>
            <li>
          ...
          <ol className='text-xs md:text-base list-decimal mb-8 px-6 leading-6 md:leading-8'>
            ...
            <li>
              ...
              <ol className='text-xs md:text-base list-decimal my-4 px-6 leading-6 md:leading-8'>
          ...
          <ol className='text-xs md:text-base list-decimal mb-8 mx-6 leading-6 md:leading-8'>
            <li>
          ...
          <ol className='text-xs md:text-base list-decimal mb-8 mx-6 leading-6 md:leading-8'>
            <li>
              ...
              <ol className='text-xs md:text-base list-decimal my-4 mx-6 leading-6 md:leading-8'>
          ...
          <ol className='text-xs md:text-base list-decimal mx-6 mb-4 md:mb-8 leading-6 md:leading-8'>
