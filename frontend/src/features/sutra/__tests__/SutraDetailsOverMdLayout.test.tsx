...
describe('SutraDetailsOverMdLayout', () => {
  ...
  beforeEach(() => {
    render(<SutraDetailsOverMdLayout sutra={mockSutra} photo={mockPhoto} />)
  })

  it('should correctly display the SutraDetailsOverMdLayout component', () => {
