...
const DeletePhotoForMdLayout = ({ photoId }: DeletePhotoProps) => {
  ...
  return (
    <>
      <button data-testid='delete-photo-button-for-md-layout' onClick={openModal}>
        削除する
      </button>
      <Modal
        isOpen={modalIsOpen}
      ...
      >
        <div className='bg-white rounded-md px-4 pt-5 pb-4 overflow-auto shadow-xl transform transition-all sm:max-w-lg sm:w-full sm:p-6'>
          ...
          <div className='mt-5 sm:mt-4 sm:flex sm:flex-row-reverse'>
            <button
              data-testid='delete-photo-confirm-button-for-md-layout'
              type='button'
            ...
            <button
              data-testid='delete-photo-cancel-button-for-md-layout'
              type='button'
...
export default DeletePhotoForMdLayout
