  ...
  return (
    <div>
      <textarea
        ...
        rows={rows}
        cols={cols}
        className='block p-2.5 w-full h-32 2xl:text-base text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500'
      ></textarea>
